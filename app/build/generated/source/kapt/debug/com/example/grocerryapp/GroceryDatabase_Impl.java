  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `grocery_items` (`itemName` TEXT NOT NULL, `itemQuantity` INTEGER NOT NULL, `itemPrice` INTEGER NOT NULL, `id` INTEGER PRIMARY KEY AUTOINCREMENT)");
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoGroceryItems.equals(_existingGroceryItems)) {
          return new RoomOpenHelper.ValidationResult(false, "grocery_items(com.example.grocerryapp.GroceryItems).\n"
                  + " Expected:\n" + _infoGroceryItems + "\n"
                  + " Found:\n" + _existingGroceryItems);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "d178d63a907e32f0287384f2f30675b4", "20521a980aba3f36b624f196c61a6217");
